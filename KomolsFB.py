...
def baliho():
	try:
		...
		print ' ' + W
		print ('KomolsFB').center(44)
		print (W + '     [' + G +'Facebook Information Gathering By KOMOL SAHA'+ W + ']')
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'KomolsFB' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'KomolsFB' + W +'/' + R +'Bot ' + W + '>> ')
